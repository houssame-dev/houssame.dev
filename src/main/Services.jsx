          ...
          <Col lg={4} md={6} className="service-col">
            <Card>
              <Card.Body>
                ...
                <hr />
                <Card.Text>
                  My websites are optimized for speed, providing an instant and
                  smooth user experience. Faster websites also rank better in
                  search engines!
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col lg={4} md={6} className="service-col">
            <Card>
              <Card.Body>
                ...
                <hr />
                <Card.Text>
                  I build websites with SEO best practices in mind, giving your
                  online presence the best chance to rise in search engine
                  rankings.
                </Card.Text>
              </Card.Body>
            </Card>
            ...
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  maintenance and support packages to keep your website running
                  smoothly.
                </Card.Text>
              </Card.Body>
            </Card>
